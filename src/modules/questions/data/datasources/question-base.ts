...
export abstract class QuestionBaseDataSource {
	...
	abstract listenToOne: (id: string, listener: Listeners<QuestionFromModel>) => Promise<() => void>
	abstract listenToMany: (listener: Listeners<QuestionFromModel>) => Promise<() => void>
