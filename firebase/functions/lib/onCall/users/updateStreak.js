...
exports.updateStreak = functions.runWith(functions_1.defaultConfig).https.onCall(async (_, context) => {
    if (!context.auth)
...
const updateUserStreak = async (userId) => {
    ...
    const { lastCheck = 0, count = 0, longestStreak = 0 } = (_a = streak.val()) !== null && _a !== void 0 ? _a : {};
