<template>
	<div class="px-md-2 p-1">
		...
		<p>
			...
			maintain the highest standards of conduct while improving learning.
			This Honour Code defines the expected standards which must be adhered to by all parties involved, in the
			conduct of academic affairs on Stranerd.
			<br> <br>
			Stranerd embodies a spirit of trust, honesty amongst others, which is central to facilitating the learning
			process of every academic. Stranerd’s vision is one that intends to facilitate learning but the adoption of
		...
		<div>
			...
			Post answers to a test, being fully aware that such tests might be used in the future by your institution
			and that future takers of the test may be on Stranerd <br>
		...
		<p>
			As a member and User of Stranerd services, I pledge to abide by all policies as communicated and will
			conduct myself and all my actions with utmost integrity which this platform represents.
			I will not engage in or assist any act of dishonesty, cheating, plagiarism or any act that compromises the
			integrity of this platform. I understand and agree to be subject to the appropriate disciplinary actions
		...
		<p>
			If you have found test questions or answers on Stranerd that are in violation of this Honour Code, please
			submit a report to us at support@stranerd.com and we will address the issue promptly.
		</p>
	</div>
</template>
